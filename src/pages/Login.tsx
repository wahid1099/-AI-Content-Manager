            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  ...
                  disabled={isLoading}
                  className="h-12 bg-background/50 backdrop-blur-sm border-border/20 rounded-xl transition-spring hover:scale-[1.02] hover:shadow-soft disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {isLoading ? (
                    <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                  ) : (
