                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    ...
                    >
                      {({ isActive }) => (
                        <>
                          <item.icon className={`w-5 h-5 transition-spring ${
                            isActive ? "text-primary-foreground" : "text-slate-500 dark:text-muted-foreground group-hover:text-primary"
                          }`} />
                          <span className="font-medium text-responsive-sm">{item.title}</span>
                        </>
                      )}
                    </NavLink>
                  </SidebarMenuButton>
      ...
      <SidebarFooter className="p-4 border-t border-border/20">
        ...
        <div className="flex items-center space-x-3 p-3 rounded-xl bg-gradient-to-r from-background/50 to-background/30 backdrop-blur-sm border border-border/20 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-medium text-sm truncate text-slate-800 dark:text-foreground">Wahid Ahmed</p>
            <p className="text-xs text-slate-500 dark:text-muted-foreground truncate">Pro Plan</p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/20 mb-3">
          ...
          <Button size="sm" className="w-full gradient-primary interactive text-xs">
            Upgrade Now
          </Button>
        </div>
